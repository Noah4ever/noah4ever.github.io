...
export default function Nolicom() {
  ...
  const highlightCpp = (code: string) => {
    ...
    const highlighted = withPlaceholders
      ...
      .replace(
        /\b(esp_now_send|analogRead|ledcWrite|esp_sleep_enable_ext0_wakeup|esp_deep_sleep_start|memcmp|leds|buzz|disp|buttonPressed)\b/g,
  ...
  const Arrow = () => (
    <ArrowIcon className="nolicom-inline-arrow" aria-hidden="true" />
  );
  ...
  return (
    <div className="nolicom-page">
      ...
      <section
        className="project-section nolicom-story"
        aria-labelledby="nolicom-problem-heading"
      >
        ...
        <blockquote>
          ...
          <p>
            <Trans
              i18nKey="nolicom.problem.p3"
              components={[<Arrow key="problem-arrow" />]}
            />
          </p>
        </blockquote>
      </section>
      ...
      <section
        className="nolicom-alternating"
        data-image-side="right"
        aria-labelledby="nolicom-concept-heading"
      >
        <div className="nolicom-alt-text">
          ...
          <p>
            <Trans
              i18nKey="nolicom.concept.p2"
              components={[<Arrow key="concept-arrow" />]}
            />
          </p>
        ...
        <div className="nolicom-alt-image">
          <figure>
            <ImageBorder
              src={media(
                "Retro 1980s Electronic Device Design-second-mocku.webp",
              )}
      ...
      <section
        ...
        aria-labelledby="nolicom-hardware-heading"
      >
        <div className="nolicom-alt-image">
          <figure>
            <ImageBorder
      ...
      <section
        ...
        aria-labelledby="nolicom-comms-heading"
      >
        <h2 id="nolicom-comms-heading">{t("nolicom.comms.title")}</h2>
        <p>
          {t("nolicom.comms.protocolPrefix")} <strong>ESP-NOW</strong>{" "}
          {t("nolicom.comms.protocolSuffix")}
        </p>
  ...
  if (buttonPressed()) {
    esp_now_send(peerMac, (uint8_t*)"PING", 4);
      ...
      <section
        className="nolicom-alternating"
        data-image-side="right"
        aria-labelledby="nolicom-prototype-heading"
      >
        <div className="nolicom-alt-text">
        ...
        <div className="nolicom-alt-image">
          <figure>
            <video
              className="nolicom-inline-video"
              controls
              playsInline
              preload="metadata"
            >
              <source
                src={
                  media(
                    "first-esp-now-test-bugs-with-esp32-looping-weird-and-not-responding.MP4",
                  ) + "#t=0.001"
                }
                type="video/mp4"
              />
      ...
      <section
        className="project-section"
        aria-labelledby="nolicom-build-heading"
      >
        ...
        <div className="nolicom-media-grid two-up">
          <figure>
            <ImageBorder
              src={media("magnifier-push-button-soldering-wide-angle.webp")}
              alt={t("nolicom.media.magnifierWideAlt")}
              lookAtCursor
            />
          ...
          <figure>
            <ImageBorder
              src={media("first-prototype-a-lot-of-cables.webp")}
              alt={t("nolicom.media.firstPrototypeAlt")}
              lookAtCursor
            />
        ...
        <div className="nolicom-media-grid two-up">
          <figure>
            <ImageBorder
              src={media("prototype-on-breadboard.webp")}
              alt={t("nolicom.media.breadboard2Alt")}
              lookAtCursor
            />
          ...
          <figure>
            <ImageBorder
              src={media("magnifier-esp32-soldering.webp")}
              alt={t("nolicom.media.espSolderAlt")}
              lookAtCursor
            />
        ...
        <div className="nolicom-video-row full-width">
          <figure>
            <video controls playsInline preload="metadata">
              <source
                src={
                  media("prototype-test-with-lights-and-buzzer-sound.mp4") +
                  "#t=0.001"
                }
                type="video/mp4"
              />
      ...
      <section
        className="project-section nolicom-workspace"
        aria-labelledby="nolicom-workspace-heading"
      >
        ...
        <div className="nolicom-media-grid two-up">
          <figure>
            <ImageBorder
              ...
              alt={t("nolicom.media.workspaceAlt")}
              lookAtCursor
            />
          ...
          <figure className="nolicom-workspace-video">
            <video controls playsInline preload="metadata">
              <source
                src={media("workspace-video.MOV") + "#t=0.001"}
                type="video/mp4"
              />
            </video>
      ...
      <section
        className="nolicom-alternating"
        data-image-side="left"
        aria-labelledby="nolicom-enclosure-heading"
      >
        <div className="nolicom-alt-image">
          <figure>
            <ImageBorder
              src={media("3d-model-blender.webp")}
              alt={t("nolicom.media.blenderAlt")}
              frame="safari"
              lookAtCursor
            />
          ...
          <figure>
            <ImageBorder
              src={media("3d-model-blender-wireframe.webp")}
              alt={t("nolicom.media.wireframeAlt")}
              frame="safari"
              lookAtCursor
            />
        ...
        <div className="nolicom-alt-text">
          ...
          <p>
            <Trans
              i18nKey="nolicom.enclosure.p3"
              components={[<em key="enclosure-em" />]}
            />
          </p>
          ...
          <div className="nolicom-media-grid">
            <figure>
              <ImageBorder
                src={media("3d-model-of-retro-case.webp")}
                alt={t("nolicom.media.caseShowcaseAlt")}
                frame="safari"
                lookAtCursor
              />
      ...
      <section
        className="project-section"
        aria-labelledby="nolicom-printing-heading"
      >
        <h2 id="nolicom-printing-heading">{t("nolicom.printing.title")}</h2>
        <p>{t("nolicom.printing.p1")}</p>
        <p>
          <Trans
            i18nKey="nolicom.printing.p2"
            components={[<em key="printing-em" />]}
          />
        </p>
        <div className="nolicom-media-grid two-up">
          <figure>
            <ImageBorder
              src={media("prototype-pla-front.webp")}
              alt={t("nolicom.media.plaAlt")}
              lookAtCursor
            />
        ...
        <div className="nolicom-video-row full-width media-height-restrict">
          <figure>
            <video controls playsInline preload="metadata">
              <source
                src={media("pla-3d-printer-printing.MP4") + "#t=0.001"}
                type="video/mp4"
              />
            </video>
      ...
      <section
        className="project-section nolicom-finishing"
        aria-labelledby="nolicom-finishing-heading"
      >
        ...
        <div className="nolicom-media-grid full-width media-height-restrict">
          <figure>
            <ImageBorder
              ...
              alt={t("nolicom.media.paintedAlt")}
              lookAtCursor
            />
        ...
        <div className="nolicom-media-grid full-width media-height-restrict">
          <figure>
            <ImageBorder
              src={media("finished-case-colored-slight-color-cracks.webp")}
              alt={t("nolicom.media.cracksAlt")}
              lookAtCursor
            />
        ...
        <div className="nolicom-media-grid full-width media-height-restrict">
          <figure>
            <ImageBorder
              src={media("broken-case.webp")}
              alt={t("nolicom.media.brokenAlt")}
              lookAtCursor
            />
      ...
      <section
        className="project-section"
        aria-labelledby="nolicom-lessons-heading"
      >
        ...
        <div className="nolicom-columns">
          <article className="nolicom-column-card">
            ...
            <p>
              <Trans
                i18nKey="nolicom.lessons.techText"
                components={[<Arrow key="lessons-arrow" />]}
              />
            </p>
          </article>
          <article className="nolicom-column-card">
      ...
      <section
        className="project-section"
        aria-labelledby="nolicom-future-heading"
      >
      ...
      <section
        className="project-section"
        aria-labelledby="nolicom-conclusion-heading"
      >
